...
package com.hyunnyapp.easycursor.sqlcursor.querymodels;
...
import com.hyunnyapp.easycursor.EasyQueryModel;
import com.hyunnyapp.easycursor.sqlcursor.BooleanLogic;
import com.hyunnyapp.easycursor.sqlcursor.EasySqlCursor;
import com.hyunnyapp.easycursor.sqlcursor.querybuilders.interfaces.QueryModelInfo;
import com.hyunnyapp.easycursor.sqlcursor.querybuilders.interfaces.SqlRawQueryBuilder;
import com.hyunnyapp.easycursor.sqlcursor.querybuilders.interfaces.SqlSelectBuilder;
import com.hyunnyapp.easycursor.util.JsonPayloadHelper;
...
public abstract class SqlQueryModel implements EasyQueryModel {
     ...
     *
     * @param db           the database to run the query against
     * @param booleanLogic an Object describing the {@link BooleanLogic} for this cursor. Pass null for the {@link com.hyunnyapp.easycursor.sqlcursor.DefaultBooleanLogic}
     * @return the {@link EasySqlCursor} containing the result of the query.
     */
